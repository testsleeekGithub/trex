...
from mrex.utils.fixes import sp_version
...
from mrex.datasets import make_blobs
from mrex.datasets import make_multilabel_classification

from mrex.model_selection import fit_grid_point
...
from mrex.model_selection import StratifiedShuffleSplit
...
from mrex.model_selection import ParameterGrid
from mrex.model_selection import ParameterSampler
from mrex.model_selection._search import BaseSearchCV

from mrex.model_selection._validation import FitFailedWarning

from mrex.svm import LinearSVC, SVC
...
from mrex.linear_model import Ridge, SGDClassifier
...
def test_fit_grid_point():
    ...
    assert_raise_message(ValueError, "For evaluating multiple scores, use "
                         "mrex.model_selection.cross_validate instead.",
