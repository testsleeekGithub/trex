...
from mrex.exceptions import FitFailedWarning

from mrex.model_selection.tests.test_search import FailingClassifier
...
from mrex.utils.testing import assert_raises_regex
...
from mrex.utils.mocking import CheckingClassifier, MockDataFrame

from mrex.model_selection import cross_val_score, ShuffleSplit
from mrex.model_selection import cross_val_predict
from mrex.model_selection import cross_validate
from mrex.model_selection import permutation_test_score
from mrex.model_selection import KFold
from mrex.model_selection import StratifiedKFold
from mrex.model_selection import LeaveOneOut
from mrex.model_selection import LeaveOneGroupOut
from mrex.model_selection import LeavePGroupsOut
from mrex.model_selection import GroupKFold
from mrex.model_selection import GroupShuffleSplit
from mrex.model_selection import learning_curve
from mrex.model_selection import validation_curve
from mrex.model_selection._validation import _check_is_permutation
from mrex.model_selection._validation import _fit_and_score
from mrex.model_selection._validation import _score
...
from mrex.metrics import precision_recall_fscore_support
from mrex.metrics import precision_score
from mrex.metrics import r2_score
from mrex.metrics.scorer import check_scoring

from mrex.linear_model import Ridge, LogisticRegression, SGDClassifier
from mrex.linear_model import PassiveAggressiveClassifier, RidgeClassifier
...
from mrex.preprocessing import LabelEncoder
from mrex.pipeline import Pipeline

from io import StringIO
from mrex.base import BaseEstimator
...
from mrex.model_selection.tests.common import OneTimeSplitter
...
def test_cross_val_score():
    ...
    assert_raises(ValueError, cross_val_score, clf, X, y2, scoring="mrex")
