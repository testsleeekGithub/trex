"""
The :mod:`mrex.model_selection._validation` module includes classes and
...
def cross_validate(estimator, X, y=None, groups=None, scoring=None, cv=None,
    ...
    See Also
    ---------
    :func:`mrex.model_selection.cross_val_score`:
        Run cross-validation for single metric evaluation.

    :func:`mrex.model_selection.cross_val_predict`:
        Get predictions from each split of cross-validation for diagnostic
        purposes.

    :func:`mrex.metrics.make_scorer`:
...
def cross_val_score(estimator, X, y=None, groups=None, scoring=None, cv=None,
    ...
    See Also
    ---------
    :func:`mrex.model_selection.cross_validate`:
    ...
    if n_classes != len(classes):
        ...
        if method == 'decision_function':
            if (predictions.ndim == 2 and
                ...
                # it with. This case is found when mrex.svm.SVC is
