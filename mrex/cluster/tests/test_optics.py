...
from mrex.cluster.tests.common import generate_clustered_data
...
def test_compare_to_ELKI():
    ...
    # Does NOT work with metric='euclidean', because mrex euclidean has
