...
from mrex.cluster.affinity_propagation_ import AffinityPropagation
from mrex.cluster.affinity_propagation_ import (
    _equal_similarities_and_preferences
)
from mrex.cluster.affinity_propagation_ import affinity_propagation
