...
@deprecated("All Losses in mrex.ensemble.gradient_boosting are "
...
shape (n_estimators, ``loss_.K``)
    ...
    See also
    --------
    mrex.ensemble.HistGradientBoostingClassifier,
    mrex.tree.DecisionTreeClassifier, RandomForestClassifier
    AdaBoostClassifier
...
class GradientBoostingRegressor(BaseGradientBoosting, RegressorMixin):
    ...
    See also
    --------
    mrex.ensemble.HistGradientBoostingRegressor,
    mrex.tree.DecisionTreeRegressor, RandomForestRegressor
