"""
Testing for the gradient boosting module (mrex.ensemble.gradient_boosting).
"""
import warnings
import numpy as np
...
from mrex.datasets import (make_classification, fetch_california_housing,
                              make_regression)
from mrex.ensemble import GradientBoostingClassifier
from mrex.ensemble import GradientBoostingRegressor
from mrex.ensemble._gradient_boosting import predict_stages
...
from mrex.utils import check_random_state, tosequence
...
def test_complete_classification():
    ...
    from mrex.tree._tree import TREE_LEAF
    X, y = datasets.make_hastie_10_2(n_samples=100, random_state=1)
    k = 4
...
def test_gradient_boosting_with_init(gb, dataset_maker, init_estimator):
    # Check that GradientBoostingRegressor works when init is a mrex
    # estimator.
