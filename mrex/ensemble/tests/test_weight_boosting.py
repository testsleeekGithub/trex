"""Testing for the boost module (mrex.ensemble.boost)."""

import numpy as np
import pytest

from mrex.utils.testing import assert_array_equal, assert_array_less
from mrex.utils.testing import assert_array_almost_equal
from mrex.utils.testing import assert_raises, assert_raises_regexp
...
from mrex.ensemble import AdaBoostRegressor
from mrex.ensemble import weight_boosting
