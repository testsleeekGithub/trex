"""
Testing for Isolation Forest algorithm (mrex.ensemble.iforest).
"""
...
from mrex.ensemble.iforest import _average_path_length
...
# chunk = 3 rows:
@patch(
    "mrex.ensemble.iforest.get_chunk_n_rows",
