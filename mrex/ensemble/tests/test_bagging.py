"""
Testing for the bagging ensemble module (mrex.ensemble.bagging).
"""
...
from mrex.model_selection import GridSearchCV, ParameterGrid
from mrex.ensemble import BaggingClassifier, BaggingRegressor
from mrex.linear_model import Perceptron, LogisticRegression
from mrex.neighbors import KNeighborsClassifier, KNeighborsRegressor
from mrex.tree import DecisionTreeClassifier, DecisionTreeRegressor
from mrex.svm import SVC, SVR
from mrex.random_projection import SparseRandomProjection
...
from mrex.datasets import load_boston, load_iris, make_hastie_10_2
