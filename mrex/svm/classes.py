...
class LinearSVC(BaseEstimator, LinearClassifierMixin,
    ...
    SVC
        ...
        :class:`mrex.multiclass.OneVsRestClassifier` wrapper.

        Finally SVC can fit dense data without memory copy if the input
        is C-contiguous. Sparse data will still incur memory copy though.

    mrex.linear_model.SGDClassifier
...
class LinearSVR(LinearModel, RegressorMixin):
    ...
    Examples
    --------
    >>> from mrex.svm import LinearSVR
    ...
    mrex.linear_model.SGDRegressor
...
class SVC(BaseSVC):
    ...
    consider using :class:`mrex.linear_model.LinearSVC` or
    :class:`mrex.linear_model.SGDClassifier` instead, possibly after a
    :class:`mrex.kernel_approximation.Nystroem` transformer.
...
class SVR(BaseLibSVM, RegressorMixin):
    ...
    datasets consider using :class:`mrex.linear_model.LinearSVR` or
    :class:`mrex.linear_model.SGDRegressor` instead, possibly after a
    :class:`mrex.kernel_approximation.Nystroem` transformer.
