"""
Testing for Support Vector Machine module (mrex.svm)
...
from mrex import svm, linear_model, datasets, metrics, base
...
from mrex.utils.testing import assert_warns_message, assert_raise_message
...
from mrex.exceptions import NotFittedError, UndefinedMetricWarning
