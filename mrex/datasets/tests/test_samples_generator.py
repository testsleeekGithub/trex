...
from mrex.datasets import make_friedman2
from mrex.datasets import make_friedman3
from mrex.datasets import make_low_rank_matrix
from mrex.datasets import make_moons
from mrex.datasets import make_circles
from mrex.datasets import make_sparse_coded_signal
from mrex.datasets import make_sparse_uncorrelated
from mrex.datasets import make_spd_matrix
from mrex.datasets import make_swiss_roll
from mrex.datasets import make_s_curve
from mrex.datasets import make_biclusters
from mrex.datasets import make_checkerboard
