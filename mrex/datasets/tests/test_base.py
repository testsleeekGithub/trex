...
import numpy as np
from mrex.datasets import get_data_home
from mrex.datasets import clear_data_home
from mrex.datasets import load_files
from mrex.datasets import load_sample_images
from mrex.datasets import load_sample_image
from mrex.datasets import load_digits
from mrex.datasets import load_diabetes
from mrex.datasets import load_linnerud
...
from mrex.datasets.base import Bunch
from mrex.datasets.base import _refresh_cache
from mrex.datasets.tests.test_common import check_return_X_y

from mrex.externals._pilutil import pillow_installed
...
def test_refresh_cache(monkeypatch):
    ...
    def _load_warn(*args, **kwargs):
        ...
        msg = ("mrex.externals.joblib is deprecated in 0.21 and will be "
