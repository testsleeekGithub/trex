...
def load_files(container_path, description=None, categories=None,
    ...
    you will need to use the `mrex.feature_extraction.text` module to build
    ...
    to use most functions in `mrex.feature_extraction.text`.
...
def _refresh_cache(files, compress):
    ...
    import joblib
    msg = "mrex.externals.joblib is deprecated in 0.21"
