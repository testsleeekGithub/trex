...
(classification).
    ...
    :class:`mrex.feature_extraction.text.CountVectorizer`. For more
    advanced usage (stopword filtering, n-gram extraction, etc.), combine
    fetch_20newsgroups with a custom
    :class:`mrex.feature_extraction.text.CountVectorizer`,
    :class:`mrex.feature_extraction.text.HashingVectorizer`,
    :class:`mrex.feature_extraction.text.TfidfTransformer` or
    :class:`mrex.feature_extraction.text.TfidfVectorizer`.
