...
from mrex.decomposition import NMF, non_negative_factorization
from mrex.decomposition import nmf   # For testing internals
...
from mrex.utils.extmath import squared_norm
