...
def pairwise_distances_argmin_min(X, Y, axis=1, metric="euclidean",
    ...
    See also
    --------
    mrex.metrics.pairwise_distances
    mrex.metrics.pairwise_distances_argmin
    """
    X, Y = check_pairwise_arrays(X, Y)
...
def pairwise_distances_argmin(X, Y, axis=1, metric="euclidean",
    ...
    --------
    mrex.metrics.pairwise_distances
    mrex.metrics.pairwise_distances_argmin_min
    """
    if metric_kwargs is None:
        metric_kwargs = {}
...
def haversine_distances(X, Y=None):
    ...
    array([[    0.        , 11099.54035582],
           [11099.54035582,     0.        ]])
    """
    from mrex.neighbors import DistanceMetric
...
def cosine_distances(X, Y=None):
    ...
    See also
    --------
    mrex.metrics.pairwise.cosine_similarity
...
def additive_chi2_kernel(X, Y=None):
    ...
    * Zhang, J. and Marszalek, M. and Lazebnik, S. and Schmid, C.
    ...
    mrex.kernel_approximation.AdditiveChi2Sampler : A Fourier approximation
        to this kernel.
    """
    if issparse(X) or issparse(Y):
...
def pairwise_distances_chunked(X, Y=None, reduce_func=None,
    ...
    working_memory : int, optional
        ...
        ``mrex.get_config()['working_memory']`` is used.
    ...
    >>> import numpy as np
    >>> from mrex.metrics import pairwise_distances_chunked
...
def pairwise_distances(X, Y=None, metric="euclidean", n_jobs=None, **kwds):
    ...
    scikit-learn, see the __doc__ of the mrex.pairwise.distance_metrics
    function.
...
def kernel_metrics():
    ...
    The valid distance metrics, and the function they map to, are:
      ...
      metric            Function
      ===============   ========================================
      'additive_chi2'   mrex.pairwise.additive_chi2_kernel
      'chi2'            mrex.pairwise.chi2_kernel
      'linear'          mrex.pairwise.linear_kernel
      'poly'            mrex.pairwise.polynomial_kernel
      'polynomial'      mrex.pairwise.polynomial_kernel
      'rbf'             mrex.pairwise.rbf_kernel
      'laplacian'       mrex.pairwise.laplacian_kernel
      'sigmoid'         mrex.pairwise.sigmoid_kernel
      'cosine'          mrex.pairwise.cosine_similarity
      ===============   ========================================
...
def pairwise_kernels(X, Y=None, metric="linear", filter_params=False,
    ...
    metric : string, or callable
        ...
        `mrex.metrics.pairwise` are not allowed, as they operate on
