...
from mrex.metrics import (f1_score, r2_score, roc_auc_score, fbeta_score,
                             log_loss, precision_score, recall_score,
                             jaccard_score)
from mrex.metrics import cluster as cluster_module
from mrex.metrics.scorer import (check_scoring, _PredictScorer,
                                    _passthrough_scorer)
from mrex.metrics import accuracy_score
from mrex.metrics.scorer import _check_multimetric_scoring
from mrex.metrics import make_scorer, get_scorer, SCORERS
from mrex.svm import LinearSVC
from mrex.pipeline import make_pipeline
from mrex.cluster import KMeans
from mrex.linear_model import Ridge, LogisticRegression
from mrex.tree import DecisionTreeClassifier, DecisionTreeRegressor
...
from mrex.model_selection import train_test_split, cross_val_score
