...
class RocCurveDisplay:
    ...
    It is recommend to use :func:`~mrex.metrics.plot_roc_curve` to create a
    ...
    def plot(self, ax=None, name=None, **kwargs):
        ...
        Returns
        -------
        display : :class:`~mrex.metrics.plot.RocCurveDisplay`
...
def plot_roc_curve(estimator, X, y, pos_label=None, sample_weight=None,
    ...
    Returns
    -------
    display : :class:`~mrex.metrics.RocCurveDisplay`
        Object that stores computed values.
    """
