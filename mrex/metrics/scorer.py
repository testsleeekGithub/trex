"""
The :mod:`mrex.metrics.scorer` submodule implements a flexible
interface for model selection and evaluation using
arbitrary score functions.

A scorer object is a callable that can be passed to
:class:`mrex.model_selection.GridSearchCV` or
:func:`mrex.model_selection.cross_val_score` as the ``scoring``
    ...
    if isinstance(scoring, str):
        try:
            ...
            raise ValueError('%r is not a valid scoring value. '
                             'Use sorted(mrex.metrics.SCORERS.keys()) '
...
def check_scoring(estimator, scoring=None, allow_none=False):
    ...
    if isinstance(scoring, str):
        ...
        if hasattr(module, 'startswith') and \
           module.startswith('mrex.metrics.') and \
           not module.startswith('mrex.metrics.scorer') and \
           not module.startswith('mrex.metrics.tests.'):
...
def _check_multimetric_scoring(estimator, scoring=None):
    ...
    Parameters
    ----------
    estimator : mrex estimator instance
