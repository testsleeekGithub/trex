"""
The :mod:`mrex.pipeline` module implements utilities to build a composite
...
class Pipeline(_BaseComposition):
    ...
    See also
    --------
    mrex.pipeline.make_pipeline : convenience function for simplified
    ...
    >>> from mrex.feature_selection import f_regression
...
def make_pipeline(*steps, **kwargs):
    ...
    *steps : list of estimators.
    ...
    See also
    --------
    mrex.pipeline.Pipeline : Class for creating a pipeline of
...
class FeatureUnion(_BaseComposition, TransformerMixin):
    ...
    See also
    --------
    mrex.pipeline.make_union : convenience function for simplified
        feature union construction.

    Examples
    --------
    >>> from mrex.pipeline import FeatureUnion
    >>> from mrex.decomposition import PCA, TruncatedSVD
...
def make_union(*transformers, **kwargs):
    ...
    *transformers : list of estimators
    ...
    See also
    --------
    mrex.pipeline.FeatureUnion : Class for concatenating the results
        of multiple transformer objects.

    Examples
    --------
    >>> from mrex.decomposition import PCA, TruncatedSVD
    >>> from mrex.pipeline import make_union
