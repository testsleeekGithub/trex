...
from mrex.datasets import load_digits, load_iris
...
from mrex.naive_bayes import GaussianNB, BernoulliNB
from mrex.naive_bayes import MultinomialNB, ComplementNB
