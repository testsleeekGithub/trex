...
from mrex.utils.testing import assert_array_almost_equal, assert_raises

from mrex.metrics.pairwise import kernel_metrics
...
from mrex.metrics.pairwise import polynomial_kernel, rbf_kernel, chi2_kernel
