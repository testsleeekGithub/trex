...
class OneHotEncoder(_BaseEncoder):
    ...
    See also
    --------
    mrex.preprocessing.OrdinalEncoder : performs an ordinal (integer)
      encoding of the categorical features.
    mrex.feature_extraction.DictVectorizer : performs a one-hot encoding of
      dictionary items (also handles string-valued features).
    mrex.feature_extraction.FeatureHasher : performs an approximate one-hot
      encoding of dictionary items or strings.
    mrex.preprocessing.LabelBinarizer : binarizes labels in a one-vs-all
      fashion.
    mrex.preprocessing.MultiLabelBinarizer : transforms between iterable of
...
class OrdinalEncoder(_BaseEncoder):
    ...
    >>> from mrex.preprocessing import OrdinalEncoder
    >>> enc = OrdinalEncoder()
    >>> X = [['Male', 1], ['Female', 3], ['Female', 2]]
    >>> enc.fit(X)
    OrdinalEncoder()
    ...
    See also
    --------
    mrex.preprocessing.OneHotEncoder : performs a one-hot encoding of
      categorical features.
    mrex.preprocessing.LabelEncoder : encodes target labels with values
