...
from mrex.utils import gen_batches
...
from mrex.utils.testing import assert_allclose_dense_sparse
from mrex.utils.testing import skip_if_32bit

from mrex.utils.sparsefuncs import mean_variance_axis
from mrex.preprocessing.data import _handle_zeros_in_scale
from mrex.preprocessing.data import Binarizer
from mrex.preprocessing.data import KernelCenterer
from mrex.preprocessing.data import Normalizer
from mrex.preprocessing.data import normalize
from mrex.preprocessing.data import StandardScaler
from mrex.preprocessing.data import scale
from mrex.preprocessing.data import MinMaxScaler
from mrex.preprocessing.data import minmax_scale
from mrex.preprocessing.data import QuantileTransformer
from mrex.preprocessing.data import quantile_transform
from mrex.preprocessing.data import MaxAbsScaler
from mrex.preprocessing.data import maxabs_scale
from mrex.preprocessing.data import RobustScaler
from mrex.preprocessing.data import robust_scale
from mrex.preprocessing.data import add_dummy_feature
from mrex.preprocessing.data import PolynomialFeatures
from mrex.preprocessing.data import PowerTransformer
from mrex.preprocessing.data import power_transform
from mrex.preprocessing.data import BOUNDS_THRESHOLD
from mrex.exceptions import NotFittedError

from mrex.base import clone
from mrex.pipeline import Pipeline
from mrex.model_selection import cross_val_predict
from mrex.svm import SVR
...
def test_deprecated_quantile_transform_copy():
    future_message = ("The default value of `copy` will change from False to "
                      ...
                      ":mod:`mrex.preprocessing.data` and prevent "
