"""
The :mod:`mrex.utils` module includes various utilities.
"""
...
# deprecate the joblib API in mrex in favor of using directly joblib
...
def indices_to_mask(indices, mask_length):
    ...
    Examples
    --------
    >>> from mrex.utils import indices_to_mask
    >>> indices = [1, 2 , 3, 4]
...
def _approximate_mode(class_counts, n_draws, rng):
    ...
    --------
    >>> import numpy as np
    >>> from mrex.utils import _approximate_mode
