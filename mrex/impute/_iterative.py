...
class IterativeImputer(BaseEstimator, TransformerMixin):
    ...
    .. note::
      ...
      you need to explicitly import ``enable_iterative_imputer``::
        ...
        >>> # now you can import normally from mrex.impute
    ...
    initial_strategy : str, optional (default="mean")
        ...
        ``strategy`` parameter in :class:`mrex.impute.SimpleImputer`
    ...
    Attributes
    ----------
    initial_imputer_ : object of type :class:`mrex.impute.SimpleImputer`
    ...
    indicator_ : :class:`mrex.impute.MissingIndicator`
    ...
    def _impute_one_feature(self,
        ...
        estimator : estimator with mrex API
