"""
Testing for the tree module (mrex.tree).
"""
import copy
import pickle
...
from mrex.tree import ExtraTreeClassifier
from mrex.tree import ExtraTreeRegressor

from mrex import tree
from mrex.tree._tree import TREE_LEAF, TREE_UNDEFINED
from mrex.tree.tree import CRITERIA_CLF
from mrex.tree.tree import CRITERIA_REG
from mrex import datasets

from mrex.utils import compute_sample_weight
...
def test_realloc():
    from mrex.tree._utils import _realloc_test
