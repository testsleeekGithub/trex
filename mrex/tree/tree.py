...
class DecisionTreeClassifier(BaseDecisionTree, ClassifierMixin):
    ...
    tree_ : Tree object
        ...
        ``help(mrex.tree._tree.Tree)`` for attributes of Tree object and
...
class ExtraTreeClassifier(DecisionTreeClassifier):
    ...
    See also
    --------
    ExtraTreeRegressor, mrex.ensemble.ExtraTreesClassifier,
    mrex.ensemble.ExtraTreesRegressor
...
class ExtraTreeRegressor(DecisionTreeRegressor):
    ...
    See also
    --------
    ExtraTreeClassifier, mrex.ensemble.ExtraTreesClassifier,
    mrex.ensemble.ExtraTreesRegressor
