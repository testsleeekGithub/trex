"""
The :mod:`mrex.compose._column_transformer` module implements utilities
...
boolean mask array or callable
    ...
    See also
    --------
    mrex.compose.make_column_transformer : convenience function for
...
boolean mask array or callable
    ...
    See also
    --------
    mrex.compose.ColumnTransformer : Class that allows combining the
