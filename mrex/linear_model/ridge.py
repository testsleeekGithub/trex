...
def ridge_regression(X, y, alpha, sample_weight=None, solver='auto',
    ...
    solver : {'auto', 'svd', 'cholesky', 'lsqr', 'sparse_cg', 'sag', 'saga'}
        ...
        - 'sag' uses a Stochastic Average Gradient descent, and 'saga' uses
          ...
          scaler from mrex.preprocessing.
    ...
    return_intercept : boolean, default False
        ...
        data, use mrex.linear_model._preprocess_data before your regression.
...
class Ridge(_BaseRidge, RegressorMixin):
    ...
    normalize : boolean, optional, default False
        ...
        :class:`mrex.preprocessing.StandardScaler` before calling ``fit``
    ...
    :class:`mrex.kernel_ridge.KernelRidge` : Kernel ridge regression
...
class RidgeClassifier(LinearClassifierMixin, _BaseRidge):
    ...
    Examples
    --------
    >>> from mrex.datasets import load_breast_cancer
    >>> from mrex.linear_model import RidgeClassifier
...
class RidgeCV(_BaseRidgeCV, RegressorMixin):
    ...
    cv : int, cross-validation generator or an iterable, optional
        ...
        :class:`mrex.model_selection.StratifiedKFold` is used, else,
        :class:`mrex.model_selection.KFold` is used.
...
class RidgeClassifierCV(LinearClassifierMixin, _BaseRidgeCV):
    ...
    --------
    >>> from mrex.datasets import load_breast_cancer
    >>> from mrex.linear_model import RidgeClassifierCV
    >>> X, y = load_breast_cancer(return_X_y=True)
