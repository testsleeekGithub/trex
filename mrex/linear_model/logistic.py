...
def _log_reg_scoring_path(X, y, train, test, pos_class=None, Cs=10,
    ...
    scoring : callable or None, optional, default: None
        ...
        that can be used, look at :mod:`mrex.metrics`. The
...
class LogisticRegression(BaseEstimator, LinearClassifierMixin,
    ...
    solver : str, {'newton-cg', 'lbfgs', 'liblinear', 'sag', 'saga'}, \
        ...
        preprocess the data with a scaler from mrex.preprocessing.
...
class LogisticRegressionCV(LogisticRegression, BaseEstimator,
    ...
    cv : int or cross-validation generator, optional (default=None)
        ...
        See the module :mod:`mrex.model_selection` module for the
    ...
    solver : str, {'newton-cg', 'lbfgs', 'liblinear', 'sag', 'saga'}, \
        ...
        with a scaler from mrex.preprocessing.
    ...
    --------
    >>> from mrex.datasets import load_iris
    >>> from mrex.linear_model import LogisticRegressionCV
    >>> X, y = load_iris(return_X_y=True)
