...
def test_lasso_lars_vs_R_implementation():
    # Test that mrex LassoLars implementation agrees with the LassoLars
    ...
    ###########################################################################
    # Scenario 1: Let's compare R vs mrex when fit_intercept=False and
    # normalize=False
    ###########################################################################
    #
    ...
    ###########################################################################
    # Scenario 2: Let's compare R vs mrex when fit_intercept=True and
    # normalize=True
    #
    # Note: When normalize is equal to True, R returns the coefficients in
    # their original units, that is, they are rescaled back, whereas mrex
    ...
    # Let's rescale back the coefficients returned by mrex before comparing
