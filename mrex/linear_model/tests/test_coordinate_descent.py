...
from mrex.linear_model.coordinate_descent import Lasso, \
    LassoCV, ElasticNet, ElasticNetCV, MultiTaskLasso, MultiTaskElasticNet, \
    MultiTaskElasticNetCV, MultiTaskLassoCV, lasso_path, enet_path
from mrex.linear_model import LassoLarsCV, lars_path
...
def test_lassoCV_does_not_set_precompute(monkeypatch, precompute,
    ...
    monkeypatch.setattr("mrex.linear_model.coordinate_descent.Lasso",
                        LassoMock)
