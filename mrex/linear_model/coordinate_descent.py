...
def lasso_path(X, y, eps=1e-3, n_alphas=100, alphas=None,
    ...
    **params : kwargs
    ...
    >>> # same path
    >>> from mrex.linear_model import lars_path
    ...
    LassoCV
    LassoLarsCV
    mrex.decomposition.sparse_encode
    """
...
class ElasticNetCV(LinearModelCV, RegressorMixin):
    ...
    Examples
    --------
    >>> from mrex.linear_model import ElasticNetCV
    >>> from mrex.datasets import make_regression
...
class MultiTaskLassoCV(LinearModelCV, RegressorMixin):
    ...
    Examples
    --------
    >>> from mrex.linear_model import MultiTaskLassoCV
    >>> from mrex.datasets import make_regression
