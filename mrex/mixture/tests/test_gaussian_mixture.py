...
from mrex.covariance import EmpiricalCovariance
from mrex.datasets.samples_generator import make_spd_matrix
from io import StringIO
from mrex.metrics.cluster import adjusted_rand_score
from mrex.mixture.gaussian_mixture import GaussianMixture
from mrex.mixture.gaussian_mixture import (
    _estimate_gaussian_covariances_full,
    _estimate_gaussian_covariances_tied,
    _estimate_gaussian_covariances_diag,
    _estimate_gaussian_covariances_spherical)
from mrex.mixture.gaussian_mixture import _compute_precision_cholesky
from mrex.mixture.gaussian_mixture import _compute_log_det_cholesky
from mrex.exceptions import ConvergenceWarning, NotFittedError
from mrex.utils.extmath import fast_logdet
...
def test_check_X():
    from mrex.mixture.base import _check_X
    rng = np.random.RandomState(0)
