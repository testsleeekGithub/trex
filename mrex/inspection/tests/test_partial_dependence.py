...
from mrex.inspection.partial_dependence import (
    _grid_from_X,
...
from mrex.linear_model import MultiTaskLasso
from mrex.tree import DecisionTreeRegressor
from mrex.datasets import load_boston, load_iris
...
@pytest.mark.parametrize('Estimator',
                         (mrex.tree.DecisionTreeClassifier,
                          mrex.tree.ExtraTreeClassifier,
                          mrex.ensemble.ExtraTreesClassifier,
                          mrex.neighbors.KNeighborsClassifier,
                          mrex.neighbors.RadiusNeighborsClassifier,
                          mrex.ensemble.RandomForestClassifier))
