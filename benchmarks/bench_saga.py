...
Benchmarks of mrex SAGA vs lightning SAGA vs Liblinear. Shows the gain
...
from mrex.datasets import fetch_rcv1, load_iris, load_digits, \
...
from mrex.preprocessing import LabelBinarizer, LabelEncoder
from mrex.utils.extmath import safe_sparse_dot, softmax
