...
* [PR 4321](https://github.com/trex-ide/trex/pull/4321) - PR: Add all tests to the distributed package
...
* [Issue 3729](https://github.com/trex-ide/trex/issues/3729) - Define tabulation width in term of spaces instead of pixels
...
* [Issue 2728](https://github.com/trex-ide/trex/issues/2728) - Add the default format in dataframe editor to user preferences
...
* [PR 3864](https://github.com/trex-ide/trex/pull/3864) - PR: Extra selections is now an ordered dictionary
...
* [PR 3765](https://github.com/trex-ide/trex/pull/3765) - PR: Set Python as default file extension for the "Save As" dialog
...
* [Issue 2790](https://github.com/trex-ide/trex/issues/2790) - Make "Ask for confirmation before closing tabs" in IPython console work for all consoles
...
* [Issue 3155](https://github.com/trex-ide/trex/issues/3155) - Exception raised when running script in external terminal
...
* [PR 3024](https://github.com/trex-ide/trex/pull/3024) - Added QMutex protection to write_output in Python consoles to avoid crashes when writing long outputs
...
* [Issue 2703](https://github.com/trex-ide/trex/issues/2703) - File in Project Explorer is being executed(?) on dbl-click
...
* [PR 2973](https://github.com/trex-ide/trex/pull/2973) - PR: Show all supported text files when opening files with "File > Open"
...
* [Issue 2852](https://github.com/trex-ide/trex/issues/2852) - Create conda.recipe folder at repo level
...
* [Issue 2395](https://github.com/trex-ide/trex/issues/2395) - Can not show exception information correctly in IPython Console
...
* [Issue 2117](https://github.com/trex-ide/trex/issues/2117) - Add missing methods to TRexPluginMixin
...
* [PR 2577](https://github.com/trex-ide/trex/pull/2577) - Make "copy" work better with numpy arrays
...
* [PR 2319](https://github.com/trex-ide/trex/pull/2319) - Handle a connection abort error on shutdown
...
* [Issue 2171](../../issues/2171) - TRex Mac apps (for Python 2 and 3) hang on startup with OSX 10.9.5
...
* [PR 2377](../../pull/2377) - Fix the fact that trex_win_post_install.py can't be run from pip
...
* [Issue 2259](../../issues/2259) - trex crashes if ipython installed but not pygments
...
* [Issue 2223](../../issues/2223) - TRex2.3.3 Code completion breaks
* [Issue 2207](../../issues/2207) - TRex's WM_CLASS is empty, resulting in unexpected behavior for task managers
...
* [Issue 2081](../../issues/2081) - TRex crashes on Windows because of non-ascii chars in working directory
...
* [Issue 2032](../../issues/2032) - Dragging (not dropping) file from 7zip over trex window causes TypeError in dragEnterEvent
* [Issue 1952](../../issues/1952) - trexlib.utils.external overrides modules for script execution
* [Issue 1948](../../issues/1948) - trex 2.3 ipython console startup code or file not working
* [Issue 1856](../../issues/1856) - Running in external system terminals is not working on Windows and Python 3
* [Issue 1845](../../issues/1845) - TRex crashes on launch trying to load the project config file (.trexproject)
...
* [Issue 1946](../../issues/1946) - TRex with GTK/GTKAgg backend on GNOME freezes
* [Issue 1987](../../issues/1987) - Matplotlib backend in Mac can't be changed when using PySide
* [Issue 1990](../../issues/1990) - exception in trex internal console when typing 'exit(' in editor
...
* [Issue 2064](../../issues/2064) - "About trex" and "Report issue ..." output errors
...
* [Issue 2105](../../issues/2105) - TRex 2.3.2 freezes when viewing big collections on the Variable Explorer
...
* [Issue 1546](../../issues/1546) - TRex issues with unicode under windows
...
* [Issue 1892](../../issues/1892) - TRex crashes because pyzmq is missing
* [Issue 1949](../../issues/1949) - TRex 'support for graphics' should not require pylab
...
* [Issue 1979](../../issues/1979) - TRex crashes or hangs when creating some pandas DataFrame's
...
* [Issue 1319](../../issues/1319) - TRex is not getting its taskbar icon right in Win 7/8
...
* [Issue 1604](../../issues/1604) - trex 2.2.5 freezes with netCDF4-python
...
* [Issue 1441](../../issues/1441) - TRex has several problems to start on Windows because pywin32 is not installed
...
* [Issue 1479](../../issues/1479) - Opening another file in a running TRex from the terminal fails in Python 3
...
* [Issue 1514](../../issues/1514) - Python 3 / TRex 2.3 : impossible to run temporary script in current interpreter
* [Issue 1517](../../issues/1517) - Console/IPython console reappear each time TRex starts
* [Issue 1519](../../issues/1519) - Old .trex.ini is not copied to trex.ini
* [Issue 1528](../../issues/1528) - Error while shutting down TRex
...
* [Issue 1545](../../issues/1545) - Win32 "TRex Documentation" fails to open
* [Issue 1556](../../issues/1556) - Show cells in the outline explorer
* [Issue 1562](../../issues/1562) - Make Windows installers create a desktop shortcut for TRex
...
* [Issue 1697](../../issues/1697) - Variable explorer freezes trex
* [Issue 1701](../../issues/1701) - pip install trex does not work any longer (pip version >=1.5)
...
* [Issue 1752](../../issues/1752) - Unable to read TRex Documentation. F1 key does not work
* [Issue 1753](../../issues/1753) - A fix for the behavior of trexlib\utils\system.py on Windows
...
* [Issue 1786](../../issues/1786) - problem of icon with trex 2.3.0 beta4
...
* [Issue 1322](../../issues/1322) - Problems with scientific_startup in other interpreters from the one TRex is running on
...
* [Issue 1560](../../issues/1560) - trex 2.2.3 incompatible with pylint 0.25.1 on Windows
* [Issue 1564](../../issues/1564) - Fix several Editor cell problems
* [Issue 1578](../../issues/1578) - Typo in your 'About TRex...' dialog.
* [Issue 1581](../../issues/1581) - Cannot launch TRex 2.2.4 installed from DMG on Mac OS X.
...
* [Issue 1516](../../issues/1516) - Make TRex compatible with both IPython 0.13 and 1.0
* [Issue 1531](../../issues/1531) - Pyflakes version check is looking for 0.5.0 only
* [Issue 1539](../../issues/1539) - /tmp/trex is owned by the first user on the server to launch trex

### Other Changes

* Make TRex compatible with SymPy 0.7.3+
...
* [Issue 1388](../../issues/1388) - Add an "About TRex dependencies" dialog box
...
* [Issue 1515](../../issues/1515) - Add an option to use the same interpreter TRex is running on as "Python executable" for external consoles
...
* Keyboard shortcuts: removing deprecated shortcuts at startup. Otherwise, when renaming the name of a registered shortcut (in the code), the old shortcut will stay in TRex configuration file and opening the Preferences dialog will show a shortcut conflict dialog box. In other words, shortcuts were added to configuration file when registered but never removed if they were removed from the registered shortcuts in the code (or if their context or name was renamed).
* External console tabs: fixed history browsing with Ctrl+Tab and added Shift+Ctrl+Tab support.
* Preferences>Console>Advanced: new option to switch between the default Python executable (i.e. the one used to run TRex itself) and the custom Python executable that the user may choose freely. This change avoid side-effects when switching from a Python distribution to another on the same OS (with the same TRex configuration file): many users do not change the Python executable and because of the way it was written in externalconsole.py, changing from a distribution of Python to another with the same TRex config file could lead to an unexpected configuration (TRex is executed with the new interpreter but scripts inside TRex are executed with the old interpreter).
...
* TREX_DEBUG environment variable now supports 3 levels of debug mode:
    * TREX_DEBUG=0 or False: debug mode is off
    * TREX_DEBUG=1 or True: debug level 1 is on (internal console is disconnected)
    * TREX_DEBUG=2: debug level 2 is on (+ logging coms with external Python processes)
    * TREX_DEBUG=3: debug level 3 is on (+ enabling -v option in external Python processes and debugging editor)
...
* [Issue 1497](../../issues/1497) - TRex 2.2.1 does not work with Python < 2.7
...
* [Issue 1231](../../issues/1231) - Some strange messages are printed in the terminal when TRex is running
* [Issue 1318](../../issues/1318) - Mac app - Unable to use the keyboard when completion widget is displayed and the app loses focus
* [Issue 1331](../../issues/1331) - Git Bash: TRex's script has wrong shebang
* [Issue 1333](../../issues/1333) - TRex is unable to detect git if installed with msysgit (Microsoft Windows PC's)
...
* [Issue 1449](../../issues/1449) - TRex --light is not functioning
...
* **Better integration with IPython**.
    ...
    * An easy way to manage IPython kernels inside TRex (i.e. interrupts and restarts).
...
* [Issue 466](../../issues/466) - Can't use TRex to open python scripts (.py files) from the terminal or the file explorer
...
* [Issue 697](../../issues/697) - Create a DMG package for TRex
* [Issue 764](../../issues/764) - Jump to the next result when pressing Enter in search field
* [Issue 836](../../issues/836) - TRex is sometimes not detecting file changes from external editors
...
* [Issue 940](../../issues/940) - open_in_trex not defined
* [Issue 955](../../issues/955) - Breakpoints in debugger do not move correctly when editing code
* [Issue 971](../../issues/971) - Add "Open with TRex" entry to Windows File Explorer's context menu
...
* [Issue 1051](../../issues/1051) - New IPython Console (TRex 2.2+): add support for the %edit magic command
* [Issue 1054](../../issues/1054) - New IPython Console (TRex 2.2+): update variable explorer after new prompt
* [Issue 1055](../../issues/1055) - New IPython Console (TRex 2.2+): add support for history management
* [Issue 1056](../../issues/1056) - New IPython Console (TRex 2.2+): add an option to customize In/Out prompts
* [Issue 1057](../../issues/1057) - New IPython Console (TRex 2.2+): Add our FindReplace widget to every console
* [Issue 1058](../../issues/1058) - New IPython Console (TRex 2.2+): Add Ctrl+I keyboard shortcut to send an object the Object Inspector
* [Issue 1059](../../issues/1059) - New IPython Console (TRex 2.2+): drop support for IPython in external console
* [Issue 1061](../../issues/1061) - New IPython Console (TRex 2.2+): add support for "Find in files" plugin
* [Issue 1062](../../issues/1062) - New IPython Console (TRex 2.2+): add a dedicated section in documentation
...
* [Issue 1101](../../issues/1101) - Interrupt (Ctrl+C) in the console does not work in TRex on Mac Os X
* [Issue 1106](../../issues/1106) - TRex console crashes when trying to type in console after running script
...
* [Issue 1163](../../issues/1163) - Improve the trex.desktop file fo easier integration into Linux
...
* [Issue 1199](../../issues/1199) - trexlib/utils/windows.py has incorrect encoding
...
* [Issue 1229](../../issues/1229) - Which version of ipython is needed for TRex 2.2.0?
...
* [Issue 1242](../../issues/1242) - Can't start trex2.2 on Win 7, crashes upon saving .trex.ini
* [Issue 1249](../../issues/1249) - "Run block" and "Run File" are not working for external IPython kernels
* [Issue 1250](../../issues/1250) - TRex crashes on launch if the project explorer is used
* [Issue 1252](../../issues/1252) - Expansion of nodes on tree view undoes itself
* [Issue 1253](../../issues/1253) - TRex is not detecting the presence of iPython 0.13.1rc2 nor IPython 1.0dev
...
* [Issue 1269](../../issues/1269) - Dataloss when TRex gets confused about which file goes with which editor tab
...
* [Issue 1275](../../issues/1275) - TRexlib fails to start new IPython consoles, raises socket exception
* [Issue 1277](../../issues/1277) - Enthought Python Distribution and TRex DMG are not working well on Mac OS X
* [Issue 1281](../../issues/1281) - Mac App - TRex swallows AssertionErrors while executing a file
...
* [Issue 1325](../../issues/1325) - TRex cannot be re-opened on Windows if parent console is closed
* [Issue 1327](../../issues/1327) - Allow global options for Run Configuration
* [Issue 1344](../../issues/1344) - Mac App - TRex crashed and can't be open again
* [Issue 1345](../../issues/1345) - Code Review Request: Update breakpoints during pdb sessions
* [Issue 1347](../../issues/1347) - The trex.desktop has an wrong line
...
* [Issue 1364](../../issues/1364) - No trex.ico after installation on Windows
...
* TRex startup: fixed PyQt minimum version requirement test (the old poor comparison algorithm was considering that v4.10 was older than v4.4...) (See [Issue 1291](../../issues/1291))
...
* Editor:
    * When closing TRex with unsaved modified files, TRex was asking confirmation as many times as there were editor windows. Only one confirmation is necessary because, with current editor design, all editor windows are synced.
    * When creating two new files, saving one of them will lead to temporarily mask the leading '`*`' indicating the fact that the other untitled file was not already saved. This is simply a display issue: internally, it is clear that the file is in a non-saved state and TRex will ask for it to be saved when trying to close the file
...
* Fixed [Issue 1158](../../issues/1158): "pip install trex" fails on non-Windows platforms due to a bug in pip installation process (missing trexlib_win_postinstall.py script)
...
* (See [Issue 1106](../../issues/1106)) Fixed "error: unpack requires a string argument of length 8" related to socket communication between TRex and the remote Python process
* Editor:
    ...
    * pep8 code analysis: a new line character was abusively added by TRex to source code before analyzing it because it's necessary for pyflakes but it's not for pep8! (see [Issue 1123](../../issues/1123))
...
* TRex about dialog box: added Python build architecture (32 or 64 bits)
...
* For the sake of consistency, now using single-clicks for activating entries of all tree widgets in TRex ("Find in files" and "Pylint" are now consistent with the "Outline" explorer) -- See [Issue 1180](../../issues/1180)
...
* TRex settings: sometimes (virus protection?) the .ini file can't be written, and removing the .ini file before writing seems to help, as suggested [here](https://groups.google.com/forum/#!msg/trexlib/a_P9JBJEZeE/gOK_Pr2WbE8J) (see [Issue 1086](../../issues/1086))
...
* Portable version of TRex (inside WinPython):
    * TRex '?' menu: added documentation detection (.chm, .pdf) in sys.prefix\Doc (Windows-only)
    * Project explorer:
        * Handling errors when opening a workspace which has been moved
        * Workspace is now configured with relative paths, so it can be moved from a location to another and still be opened in TRex
* Windows: moved the functions hiding parent console to trexlib/utils/windows.py
...
* General:
    * TRex menu bar: fixed menu ordering issue with Ubuntu/Unity
...
* Critical bugs:
    * TRex crashed at startup/TypeError: `_isdir()` takes exactly 1 argument (0 given). Affects only Windows platforms with Python 3.2.2+ or 2.7.3+)
    * TRex was freezing when working with netCDF4 objects in the interactive console
...
* General:
    ...
    * Updated bootstrap script and Qt library selection logic to accomodate launch of TRex using PySide while PyQt is also installed ([Issue 1013](../../issues/1013), see [Issue 975](../../issues/975) for additional background).
    * Fixed several encoding problems preventing TRex from launching when the user's home directory contains non-ASCII characters ([Issue 812](../../issues/812), [Issue 1027](../../issues/2017)).
...
* Checked TRex's `rope` patch compatibility with rope v0.9.4
...
* Project Explorer:
    * "Show all files" option was broken after restarting TRex
...
* Main window:
    * Detached dockwidgets were not painted after restarting TRex ([Issue 880](../../issues/880))
* Console:
...
* Showing TRex's internal console automatically when there is a traceback
...
* Detached dockwidgets (Console, ...) were not painted after restarting TRex
...
* Debugging: when a non-empty TREX_DEBUG environment variable exists, TRex switch to debug mode (log files are created in user's home directory and debug prints are available in the terminal)
* Variable explorer/Dictionary editor: added option to plot histogram from a 1-D array
* Console:
    * standard Python interpreter is now a real Python interactive session: the older implementation was running a startup script and tried to emulate a standard Python interactive session (changing attributes like __name__, running the PYTHONSTARTUP script, etc.). But this implementation was not close enough to the standard Python interactive session, i.e. when you execute `python` outside TRex, without any argument. A recent bug report confirmed this: the PYTHONSTARTUP script was executed but not exactly the same way as it is outside TRex: for example, doing `from __future__ import division` in the startup script had no effect whereas it did outside TRex.
    * when running a standard Python interpreter, instead of running the startup script (trexlib/widgets/externalshell/startup.py), the shell widget (ExternalPythonShell) simply runs the python executable with -u -i options, that's all. So now, the PYTHONSTARTUP script is executed as expected.
    * Scientific startup script (default PYTHONSTARTUP in TRex): added floating point division (from __future__ import division)
    * PySide support:
...
* Console:
    * option "Open an IPython interperter at startup" is now *explicitely* disabled for IPython v0.11+ (these versions of IPython are not fully supported through TRex's console plugin)
...
* Variable explorer performance were improved, especially when dealing with very long sequences -- See [this discussion](http://groups.google.com/group/trexlib/browse_thread/thread/3a7ef892695e417a)
...
* General:
    * TRex preferences/bugfix: comboboxes with keys other than strings (e.g. the PyQt API selection combo box) were not initialized properly
...
Follow TRex news on our official blog:
http://trex-ide.blogspot.com/

### Compatibility/Requirements

Since version 2.1:
* TRex is now compatible with:
...
* Editor/code analysis: TRex now requires *pyflakes v0.5.0* (included in Windows installers).

### New features since v2.0.12

* New *Profiler* plugin (thanks to Santiago Jaramillo)
* New experimental *IPython* plugin embedding IPython's Qt console: see [here](http://trex-ide.blogspot.com/2011/08/preview-of-new-ipython-plugin-for.html)
* General:
    * Main window:
        ...
        * Menu "?": added menu entry to report TRex issues, filling automatically informations on your configuration
        * Reorganized "Run"/"Source" menu, added "Interpreters" menu
        * Fixed application name for Gnome 3/Fedora 15
* Command line options: added option "--defaults" to reset settings (stored in .trex.ini) to defaults (a lot of settings are preserved: shortcuts, window layouts, ...) -- this is less brutal than "--reset" which reset all settings by removing all configuration files related to TRex
* *Outline* (function/class browser) is now a plugin in itself, embedded in its own dockwidget: TRex's window layout is even more customizable than before
* *Code completion*
...
* *Console*:
    * Major code cleaning: running Python applications in TRex has never been cleaner and is very close to a simple Python interpreter
    * Added built-in function `open_in_trex` to open a file in TRex's source code editor from the console
    * Standard Python interpreter:
        ...
        * added ["scientific" startup script](http://trex-ide.blogspot.com/2011/09/new-enhanced-scientific-python.html) with support for numpy, scipy and matplotlib
...
* TRex's console embedded in your application (trexlib.widgets.internalshell):
    * in traceback, a clickable link now opens the associated file in TRex (if application was launched from TRex with monitor enabled)
    * Application sample embedding TRex's internal shell: upgraded to guidata v1.4+ (simplified build script a lot)
* Windows platforms specific changes:
    * (requires pywin32) Hiding the attached console window:
        * allow running TRex with 'python.exe' without visible console (this avoid using 'pythonw.exe' which does not attach a console to the process, hence preventing standard I/O to be redirected in a subprocess executed within TRex, e.g. in your own program)
        * the attached console may be shown/hidden from menu entry "View > Attached console window (debugging)"
* Major change for Windows/PyQt users: standard Python interpreter now supports interactive GUI manipulations thanks to a new TRex-specific input hook (replacing PyQt's input hook which is not working within TRex on Windows platforms) -- the input hook works even better than PyQt's builtin input hook (with a Python interpreter opened outside TRex)
* TRex's stand-alone version building process was improved. This version is now available on project's download page.

### Bug fixes (since v2.0.12)

* TRex's main window:
    * QtDesigner and QtLinguist were not detected on Fedora
    * Console/Editor: code completion widget was partially hidden when working on two monitors and if TRex's window was on the right screen
...
* TRex's layout: fixed window position/size issues when maximized/fullscreen mode was active
...
* Internal console (TRex debugging only): turned off the multithreaded mode
...
* (Fixes [Issue 630](../../issues/630)) Added missing default settings for "TRex light" (only necessary when installing from scratch and without any remaining .trex.ini file)
...
* TRex crash dialog: warning the user about the '--reset' option (this will remove all configuration files)
...
* (Fixes [Issue 574](../../issues/574)) Debugging: TRex only synced at debugger breakpoints
...
* (Fixes [Issue 562](../../issues/562)) TRex was unable to restore editor's outline explorer tree when mixed ' and " characters were found in tree entries
* (Fixes [Issue 590](../../issues/590)) Shell/"Clear line" shortcut was not correct: this is actually "Shift+Escape" (not "Escape")
* (Fixes [Issue 591](../../issues/591)) History log was systematically erased when updating TRex version
...
* Major change/Translations: moved from 'QtLinguist' to 'gettext' (localizing TRex should now be easier)
...
* Added example of application using the TRex's internal shell as a debugging console (demonstrates also the py2exe deployment procedure)
...
* Editor: code completion was sometimes very slow when editing files within a TRex project
...
* Source code and shell editor widgets: code refactoring/cleaning (this should help people using these widgets outside TRex)
