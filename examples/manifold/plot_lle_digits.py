...
The RandomTreesEmbedding, from the :mod:`mrex.ensemble` module, is not
...
Linear Discriminant Analysis, from the :mod:`mrex.discriminant_analysis`
module, and Neighborhood Components Analysis, from the :mod:`mrex.neighbors`
...
from mrex import (manifold, datasets, decomposition, ensemble,
