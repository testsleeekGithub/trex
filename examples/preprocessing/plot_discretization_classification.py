...
from mrex.datasets import make_moons, make_circles, make_classification
...
from mrex.preprocessing import KBinsDiscretizer
from mrex.svm import SVC, LinearSVC
