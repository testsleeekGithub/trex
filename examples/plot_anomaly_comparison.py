...
The :class:`mrex.svm.OneClassSVM` is known to be sensitive to outliers and
...
:class:`mrex.covariance.EllipticEnvelope` assumes the data is Gaussian and
learns an ellipse. It thus degrades when the data is not unimodal. Notice
however that this estimator is robust to outliers.

:class:`mrex.ensemble.IsolationForest` and
:class:`mrex.neighbors.LocalOutlierFactor` seem to perform reasonably well
for multi-modal data sets. The advantage of
:class:`mrex.neighbors.LocalOutlierFactor` over the other estimators is
...
hypercube. Except for the :class:`mrex.svm.OneClassSVM` which overfits a
...
from mrex.datasets import make_moons, make_blobs
from mrex.covariance import EllipticEnvelope
from mrex.ensemble import IsolationForest
from mrex.neighbors import LocalOutlierFactor
