...
value using the basic :class:`mrex.impute.SimpleImputer`.
The median is a more robust estimator for data with high magnitude variables
which could dominate results (otherwise known as a 'long tail').

Another option is the :class:`mrex.impute.IterativeImputer`. This uses
...
missing information using :func:`mrex.impute.MissingIndicator` which might
