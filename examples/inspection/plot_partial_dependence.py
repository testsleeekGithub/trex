...
:class:`~mrex.neural_network.MLPRegressor` and a
:class:`~mrex.ensemble.HistGradientBoostingRegressor` trained on the
California housing dataset. The example is taken from [1]_.

The plots show four 1-way and two 1-way partial dependence plots (ommitted for
:class:`~mrex.neural_network.MLPRegressor` due to computation time). The
...
from mrex.inspection import partial_dependence
from mrex.inspection import plot_partial_dependence
...
from mrex.datasets.california_housing import fetch_california_housing
...
#
# We also observe that :class:`~mrex.neural_network.MLPRegressor` has much
# smoother predictions than
# :class:`~mrex.ensemble.HistGradientBoostingRegressor`. For the plots to be
# comparable, it is necessary to subtract the average value of the target
# ``y``: The 'recursion' method, used by default for
# :class:`~mrex.ensemble.HistGradientBoostingRegressor`, does not account
