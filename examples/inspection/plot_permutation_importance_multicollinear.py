...
breast cancer dataset using :func:`~mrex.inspection.permutation_importance`.
The :class:`~mrex.ensemble.RandomForestClassifier` can easily get about 97%
...
from mrex.inspection import permutation_importance
