...
from trex.py3compat import (is_text_string, builtins, get_meth_func,
...
if __name__ == "__main__":
    class Test(object):
        def method(self, x, y=2):
            pass
    print(getargtxt(Test.__init__))  # trex: test-skip
    print(getargtxt(Test.method))  # trex: test-skip
    print(isdefined('numpy.take', force_import=True))  # trex: test-skip
    print(isdefined('__import__'))  # trex: test-skip
    print(isdefined('.keys', force_import=True))  # trex: test-skip
    print(getobj('globals'))  # trex: test-skip
    print(getobj('globals().keys'))  # trex: test-skip
    print(getobj('+scipy.signal.'))  # trex: test-skip
    print(getobj('4.'))  # trex: test-skip
    print(getdoc(sorted))  # trex: test-skip
    print(getargtxt(sorted))  # trex: test-skip
