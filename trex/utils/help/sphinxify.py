...
- The TRex Project Contributors: Several changes to make it work with TRex
...
# Local imports
from trex.config.base import (_, get_module_data_path,
...
def generate_configuration(directory):
    ...
    conf = osp.join(get_module_source_path('trex.utils.help'),
                    'conf.py')
