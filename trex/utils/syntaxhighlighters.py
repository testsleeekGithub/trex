...
from trex.py3compat import builtins, is_text_string, to_text_string
from trex.utils.sourcecode import CELL_LANGUAGES
...
def get_color_scheme(name):
    ...
    for key in COLOR_SCHEME_KEYS:
        try:
            ...
            scheme[key] = CONF.get('color_schemes', 'trex/'+key)
    return scheme
...
class BaseSH(QSyntaxHighlighter):
    ...
    def __init__(self, parent, font=None, color_scheme='TRex'):
...
class PygmentsSH(BaseSH):
    ...
    def __init__(self, parent, font=None, color_scheme=None):
        ...
        # Map Pygments tokens to TRex tokens
