...
if __name__ == '__main__':
    ...
    print(memory_usage.__doc__)  # trex: test-skip
    print(memory_usage())  # trex: test-skip
    if os.name == 'nt':
        #  windll can only be imported if os.name = 'nt' or 'ce'
        print("*"*80)  # trex: test-skip
        print(windows_memory_usage.__doc__)  # trex: test-skip
        print(windows_memory_usage())  # trex: test-skip