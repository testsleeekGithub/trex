...
from trex.utils.introspection.module_completion import (
    get_preferred_submodules)
from trex.utils.introspection.manager import ROPE_REQVER

try:
    try:
        from trex.utils.introspection import rope_patch
        rope_patch.apply()
    except ImportError:
