...
from trex.config.base import debug_print
...
from trex.utils.introspection.manager import (
    DEBUG_EDITOR, LOG_FILENAME, IntrospectionPlugin)
from trex.utils.introspection.utils import get_parent_until
from trex.utils.introspection.manager import JEDI_REQVER

try:
    try:
        from trex.utils.introspection import jedi_patch
