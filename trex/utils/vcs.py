...
if __name__ == '__main__':
    print(get_vcs_root(osp.dirname(__file__)))  # trex: test-skip
    print(get_vcs_root(r'D:\Python\ipython\IPython\kernel'))  # trex: test-skip
    #run_vcs_tool(r'D:\Python\userconfig\userconfig', 'commit')
    print(get_git_revision(osp.dirname(__file__)+"/../.."))  # trex: test-skip
    print(get_git_revision('/'))  # trex: test-skip
