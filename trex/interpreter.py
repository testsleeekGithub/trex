...
# Local imports:
from trex.utils.dochelpers import isdefined
from trex.utils import encoding, programs
from trex.py3compat import is_text_string, getcwd
from trex.utils.misc import remove_backslashes
...
""" % pyver)
            ...
            try:
                ...
                print("no Python documentation found for '%r'" % text) # trex: test-skip
