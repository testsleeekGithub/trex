...
from trex.interpreter import Interpreter
from trex.py3compat import (builtins, getcwd, to_binary_string,
                              to_text_string, u)
from trex.utils import icon_manager as ima
from trex.utils import programs
from trex.utils.dochelpers import getargtxt, getdoc, getobjdir, getsource
from trex.utils.misc import get_error_match
from trex.utils.qthelpers import create_action
from trex.widgets.shell import PythonShellWidget
from trex.widgets.variableexplorer.objecteditor import oedit
# TODO: remove the CONF object and make it work anyway
# In fact, this 'CONF' object has nothing to do in package trex/widgets
# which should not contain anything directly related to TRex's main app
from trex.config.base import _, DEBUG, get_conf_path
...
class InternalShell(PythonShellWidget):
    ...
    def __init__(self, parent=None, namespace=None, commands=[], message=None,
        ...
        # 'open_in_trex' function in builtins)
        if hasattr(builtins, 'open_in_trex'):
            self.go_to_error.connect(self.open_with_external_trex)
    ...
    #------ External editing
    def open_with_external_trex(self, text):
        """Load file in external TRex's editor, if available
        ...
        if match:
            ...
            builtins.open_in_trex(fname, int(lnb))
