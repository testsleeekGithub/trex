...
# Local imports
from trex.config.base import _, DEV
from trex.py3compat import is_text_string, to_text_string
from trex.utils.qthelpers import (action2button, add_actions,
                                    create_action, create_toolbutton)
from trex.utils import icon_manager as ima
from trex.widgets.comboboxes import UrlComboBox
...
class FrameWebView(QFrame):
    """
    Framed QWebEngineView for UI consistency in TRex.
    """
    linkClicked = Signal(QUrl)
