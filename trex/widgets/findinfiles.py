...
from trex.py3compat import getcwd, to_text_string
from trex.utils import programs
from trex.utils import icon_manager as ima
from trex.utils.misc import abspardir, get_common_path
from trex.utils.qthelpers import create_toolbutton, get_filetype_icon
from trex.utils.vcs import is_hg_installed, get_vcs_root
from trex.widgets.comboboxes import PathComboBox, PatternComboBox
from trex.widgets.onecolumntree import OneColumnTree
...
class SearchThread(QThread):
    ...
    def find_files_in_python_path(self):
        ...
        if os.name == "nt":
            ...
            #  and  "D:\Python" in TRex's python path would lead
