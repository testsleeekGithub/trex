...
from trex.utils.qthelpers import (add_actions, create_action, keybinding,
                                    restore_keyevent)
from trex.widgets.mixins import (GetHelpMixin, SaveHistoryMixin,
                                   TracebackLinksMixin)
from trex.widgets.sourcecode.base import ConsoleBaseWidget
...
#
# from trex.utils.debug import log_methods_calls
...
class PythonShellWidget(TracebackLinksMixin, ShellBaseWidget,
    ...
    INITHISTORY = ['# -*- coding: utf-8 -*-',
                   '# *** TRex Python Console History Log ***',]
...
class TerminalWidget(ShellBaseWidget):
    ...
    INITHISTORY = ['%s *** TRex Terminal History Log ***' % COM, COM,]
