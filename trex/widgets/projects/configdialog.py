...
from trex.plugins.configdialog import ConfigDialog, GeneralConfigPage
from trex.utils.qthelpers import get_icon
from trex.config.user import NoDefault
from trex.widgets.projects import EmptyProject
from trex.widgets.projects.config import (WORKSPACE, VCS, ENCODING,
                                            CODESTYLE)
