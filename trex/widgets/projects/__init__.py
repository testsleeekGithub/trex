...
# Local imports
from trex.widgets.projects.type import EmptyProject
from trex.widgets.projects.type.python import PythonProject


def get_available_project_types():
    """ """
#    return [EmptyProject, PythonProject, PythonPackageProject, DjangoProject,
#            TRexPluginProject] + get_available_project_types_plugins()
    return ([EmptyProject] +
