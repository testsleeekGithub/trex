...
from trex.utils.bsdsocket import read_packet, write_packet
...
class IntrospectionServer(threading.Thread):
    ...
    def __init__(self):
        ...
        self.setDaemon(True)
        global TREX_PORT
        self.port = TREX_PORT = select_port(default_port=TREX_PORT)
        TREX_PORT += 1
...
def start_introspection_server():
    ...
    This server is dedicated to introspection features, i.e. TRex is calling 
...
def start_notification_server():
    ...
    are notifying TRex about anything relevant like debugging data (pdb) 
