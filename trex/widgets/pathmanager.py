...
from trex.py3compat import getcwd
from trex.utils import icon_manager as ima
from trex.utils.qthelpers import create_toolbutton
...
class PathManager(QDialog):
    ...
    def setup_bottom_toolbar(self, layout, sync=True):
        ...
        if os.name == 'nt' and sync:
            self.sync_button = create_toolbutton(self,
                  ...
                  tip=_("Synchronize TRex's path list with PYTHONPATH "
    ...
    def synchronize(self):
        ...
        if answer == QMessageBox.Cancel:
            ...
            remove = False
        from trex.utils.environ import (get_user_env, set_user_env,
                                          listdict2envdict)
        env = get_user_env()
        if remove:
        ...
        if directory:
            ...
            if directory in self.pathlist:
                answer = QMessageBox.question(self, _("Add path"),
                    _("This directory is already included in TRex path "
