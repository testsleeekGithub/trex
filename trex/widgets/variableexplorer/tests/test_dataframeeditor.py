...
def test_change_format_emits_signal(qtbot, monkeypatch):
    ...
    monkeypatch.setattr('trex.widgets.variableexplorer.dataframeeditor.QInputDialog', mockQInputDialog)
    df = DataFrame([[0]])
...
def test_change_format_with_format_not_starting_with_percent(qtbot, monkeypatch):
    ...
    monkeypatch.setattr('trex.widgets.variableexplorer.dataframeeditor'
