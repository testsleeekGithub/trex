...
from trex.widgets.variableexplorer.utils import (
...
class CollectionsDelegate(QItemDelegate):
    ...
    def createEditor(self, parent, option, index):
        ...
        try:
            ...
            QMessageBox.critical(self.parent(), _("Error"),
                                 _("TRex was unable to retrieve the value of "
        ...
        #---editor = QLineEdit
            ...
            # This is making TRex crash because the QLineEdit that it's
    ...
    def commitAndCloseEditor(self):
        ...
        # but at least TRex won't crash. It seems generated by a
        # bug in sip. See
...
class DictEditor(CollectionsEditor):
    def __init__(self, parent=None):
        warnings.warn("`DictEditor` has been renamed to `CollectionsEditor` in "
                      "TRex 3. Please use `CollectionsEditor` instead",
                      RuntimeWarning)
...
def remote_editor_test():
    ...
    from trex.widgets.variableexplorer.utils import make_remote_view
