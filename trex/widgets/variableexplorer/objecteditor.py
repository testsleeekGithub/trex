...
def test():
    ...
    print(oedit(foobar))  # trex: test-skip
    print(oedit(example))  # trex: test-skip
    print(oedit(np.random.rand(10, 10)))  # trex: test-skip
    print(oedit(oedit.__doc__))  # trex: test-skip
    print(example)  # trex: test-skip
