...
"""Module checking TRex runtime dependencies"""
...
class DependenciesTableModel(QAbstractTableModel):
    ...
    def data(self, index, role=Qt.DisplayRole):
        ...
        if role == Qt.DisplayRole:
            ...
            from trex.dependencies import Dependency
...
class DependenciesDialog(QDialog):
    def __init__(self, parent):
        ...
        self.setWindowTitle("TRex %s: %s" % (__version__,
                                               _("Dependencies")))
        ...
        self.label = QLabel(_("TRex depends on several Python modules to "
                              ...
                              "them.<br><br>"
                              "<b>Note</b>: You can safely use TRex "
                              ...
                              "detected only after TRex is restarted.")
    ...
    def copy_to_clipboard(self):
        from trex.dependencies import status
