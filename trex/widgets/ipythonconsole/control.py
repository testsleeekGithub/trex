...
from trex.utils.qthelpers import restore_keyevent
from trex.widgets.calltip import CallTipWidget
from trex.widgets.mixins import (BaseEditMixin, GetHelpMixin,
                                   TracebackLinksMixin)
...
class ControlWidget(TracebackLinksMixin, GetHelpMixin, QTextEdit,
                    BaseEditMixin):
    """
    Subclass of QTextEdit with features from TRex's mixins to use as the
    ...
    def __init__(self, parent=None):
        ...
        # To not use TRex calltips obtained through the monitor
        self.calltips = False
...
class PageControlWidget(QTextEdit, BaseEditMixin):
    """
    Subclass of QTextEdit with features from TRex's mixins.BaseEditMixin to
