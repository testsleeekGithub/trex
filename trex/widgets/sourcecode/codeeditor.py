...
# TODO: Try to separate this module from trex to create a self
...
# Local imports
from trex.config.base import get_conf_path, _, DEBUG
...
from trex.utils import syntaxhighlighters as sh
from trex.utils import encoding, sourcecode
from trex.utils.dochelpers import getobj
from trex.utils.qthelpers import add_actions, create_action, mimedata2url
from trex.utils.sourcecode import ALL_LANGUAGES, CELL_LANGUAGES
from trex.widgets.editortools import PythonCFM
from trex.widgets.sourcecode.base import TextEditBaseWidget
from trex.widgets.sourcecode.kill_ring import QtKillRing
...
#===============================================================================
    ...
    def process_code_analysis(self, check_results):
        ...
        for message, line_number in check_results:
            ...
            for ref in refs:
                ...
                # do not provide the column number -- see Issue 709 on TRex's
    ...
    def __unmatched_quotes_in_line(self, text):
        ...
        TRex team: Add some changes to deal with escaped quotes
...
class TestWidget(QSplitter):
    def __init__(self, parent):
        ...
        self.setWindowIcon(ima.icon('trex'))
...
def test(fname):
    ...
    from trex.utils.codeanalysis import (check_with_pyflakes,
                                           check_with_pep8)
