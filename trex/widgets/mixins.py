...
These classes were created to be able to provide TRex's regular text and
...
from trex.py3compat import is_text_string, to_text_string, u
from trex.utils import encoding, sourcecode, programs
from trex.utils.dochelpers import (getargspecfromtext, getobj,
...
class BaseEditMixin(object):
    ...
    # --- Numpy matrix/array helper / See 'trex/widgets/arraybuilder.py'
