...
# Local imports
from trex.config.base import _, get_home_dir
from trex.plugins import TRexPluginMixin
from trex.py3compat import is_text_string, getcwd
from trex.utils import icon_manager as ima
from trex.utils.qthelpers import add_actions, create_action, MENU_SEPARATOR
from trex.widgets.projects.explorer import ProjectExplorerWidget
from trex.widgets.projects.projectdialog import ProjectDialog
from trex.widgets.projects import EmptyProject


class Projects(ProjectExplorerWidget, TRexPluginMixin):
    """Projects plugin"""
    ...
    def edit_project_preferences(self):
        """Edit TRex active project preferences"""
        from trex.widgets.projects.configdialog import ProjectPreferences
...
#        dlg.pages_widget.currentChanged.connect(self.__preference_page_changed)
    ...
    def reopen_last_project(self):
        """
        Reopen the active project when TRex was closed last time, if any
        """
    ...
    def is_valid_project(self, path):
        """Check if a directory is a valid TRex project"""
