...
from trex.config.base import _, get_conf_path, get_module_source_path
...
from trex.utils.help.sphinxify import (CSS_PATH, generate_context,
...
class SphinxThread(QThread):
    ...
    doc : str or dict
        ...
        See trex.utils.dochelpers.getdoc for description.
    context : dict
...
class Help(TRexPluginWidget):
    ...
    def show_intro_message(self):
        ...
        if self.is_rich_text_mode():
            title = _("Usage")
            tutorial_message = _("New to TRex? Read our")
            tutorial = _("tutorial")
    ...
    def show_tutorial(self):
        tutorial_path = get_module_source_path('trex.utils.help')
