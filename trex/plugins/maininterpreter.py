...
class MainInterpreterConfigPage(GeneralConfigPage):
    ...
    def __init__(self, parent, main):
        ...
        if not osp.isfile(executable):
            ...
            # executable has been moved since last TRex execution (following
    ...
    def setup_page(self):
        ...
        pyexec_label = QLabel(_("Select the Python interpreter for all TRex "
                                "consoles"))
        def_exec_radio = self.create_radiobutton(
                                _("Default (i.e. the same as TRex's)"),
        ...
        umr_enabled_box = newcb(_("Enable UMR"), 'umr/enabled',
                        ...
                        "Python script using the TRex's builtin function "
                        "<b>runfile</b>."
