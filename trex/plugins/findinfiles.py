...
from trex.config.utils import get_edit_extensions
...
from trex.widgets.findinfiles import FindInFilesWidget
from trex.plugins import TRexPluginMixin


class FindInFiles(FindInFilesWidget, TRexPluginMixin):
    ...
    def switch_to_plugin(self):
        ...
        TRexPluginMixin.switch_to_plugin(self)
