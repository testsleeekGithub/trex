...
"""
TRex GUI-related configuration management
(for non-GUI configuration, see trex/config/base.py)
...
def get_family(families):
    ...
    for family in families:
        ...
        print("Warning: None of the following fonts is installed: %r" % families)  # trex: test-skip
        return QFont().family()
...
def fixed_shortcut(keystr, parent, action):
    """
    DEPRECATED: This function will be removed in TRex 4.0
