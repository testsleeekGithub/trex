...
"""
TRex third-party plugins configuration management
"""
...
def get_trexplugins_mods(io=False):
    ...
    for plugin_path in [user_plugin_path] + sys.path:
        _get_trexplugins(plugin_path, io, modnames, modlist)
    return modlist


def _get_trexplugins(plugin_path, is_io, modnames, modlist):
