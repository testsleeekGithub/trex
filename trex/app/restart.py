...
A helper script that allows to restart (and also reset) TRex from within the
running application.
"""
...
class Restarter(QWidget):
    ...
    def launch_error_message(self, error_type, error=None):
        ...
        error_type : int [CLOSE_ERROR, RESET_ERROR, RESTART_ERROR]
            Possible error codes when restarting/reseting trex.
        error : Exception
            Actual Python exception error caught.
        """
        messages = {CLOSE_ERROR: _("It was not possible to close the previous "
                                   "TRex instance.\nRestart aborted."),
                    RESET_ERROR: _("TRex could not reset to factory "
                                   "defaults.\nRestart aborted."),
                    RESTART_ERROR: _("It was not possible to restart TRex.\n"
                                     "Operation aborted.")}
        titles = {CLOSE_ERROR: _("TRex exit error"),
                  RESET_ERROR: _("TRex reset error"),
                  RESTART_ERROR: _("TRex restart error")}
