...
# Local imports
from trex.config.base import _, get_image_path
...
def get_tour(index):
    ...
    test = [{'title': "Welcome to TRex introduction tour",
             'content': "<b>TRex</b> is an interactive development \
                         environment. This tip panel supports rich text. <br>\
                         <br> it also supports image insertion to the right so\
                         far",
             'image': 'tour-trex-logo.png'},
    ...
    intro = [{'title': _("Welcome to the Introduction tour"),
              'content': _("<b>TRex</b> is a powerful Interactive "
             ...
             {'title': _("The Editor"),
              'content': _("This is the pane where you write Python code before "
                           ...
                           "where TRex shows warnings and syntax errors. They "
             ...
             {'title': _("The Variable Explorer"),
              'content': _("In this pane you can view and edit the variables "
                           ...
                           "those entered directly in one of TRex "
                           "consoles.<br><br>"
             ...
             {'title': _("The File Explorer"),
              'content': _("This pane lets you navigate through the directories "
                           ...
                           "files will always be opened in the TRex Editor."),
...
#                   ['The editor',
#                       'TRex has differnet bla bla bla',
...
#                      ]
    ...
    feat30 = [{'title': "New features in TRex 3.0",
               'content': _("<b>TRex</b> is an interactive development "
                            "environment based on bla"),
               'image': 'trex.png'},

              {'title': _("Welcome to TRex introduction tour"),
               'content': _("TRex is an interactive development environment "
                            "based on bla"),
...
#        painter.fillPath(self.path_decoration, decoration_fill)
    ...
    def focusInEvent(self, event):
        """Override Qt method."""
        # To be used so tips do not appear outside trex
        if self.hasFocus():
