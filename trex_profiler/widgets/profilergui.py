...
from trex.utils.qthelpers import (create_toolbutton, get_item_user_text,
                                    set_item_user_text)
from trex.utils.programs import shell_split
from trex.widgets.comboboxes import PythonModulesComboBox
from trex.utils.misc import add_pathlist_to_PYTHONPATH
...
class ProfilerWidget(QWidget):
    ...
    def start(self, wdir=None, args=None, pythonpath=None):
        ...
        if executable.endswith("trex.exe"):
            # py2exe distribution
