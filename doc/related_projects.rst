...
- `mrex_pandas <https://github.com/paulgb/mrex-pandas/>`_ bridge for
  scikit-learn pipelines and pandas data frame with dedicated transformers.
  
- `mrex_xarray <https://github.com/phausamann/mrex-xarray/>`_ provides
...
- `auto-mrex <https://github.com/automl/auto-mrex/>`_
...
- `mrex2pmml <https://github.com/jpmml/mrex2pmml>`_
  Serialization of a wide variety of scikit-learn estimators and transformers
  into PMML with the help of `JPMML-MREX <https://github.com/jpmml/jpmml-mrex>`_
  library.

- `mrex-porter <https://github.com/nok/mrex-porter>`_
  Transpile trained scikit-learn models to C, Java, Javascript and others.

- `mrex-compiledtrees <https://github.com/ajtulloch/mrex-compiledtrees/>`_
  Generate a C++ implementation of the predict function for decision trees (and
  ensembles) trained by mrex. Useful for latency-sensitive production
  environments.
...
- `mrex-crfsuite <https://github.com/TeamHG-Memex/mrex-crfsuite>`_
...
- `mrex_theano <https://mrex-theano.github.io/>`_ scikit-learn compatible
...
- `lda <https://github.com/ariddell/lda/>`_: Fast implementation of latent
  ...
  :class:`mrex.decomposition.LatentDirichletAllocation` implementation uses
...
- `categorical-encoding
  ...
  library of mrex compatible categorical variable encoders.
