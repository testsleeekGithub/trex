...
An example of an estimator is the class ``mrex.svm.SVC``, which
...
:func:`SVC.set_params()<mrex.svm.SVC.set_params>` after the estimator has
...
When using :class:`multiclass classifiers <mrex.multiclass>`,
...
using the :class:`LabelBinarizer <mrex.preprocessing.LabelBinarizer>`.
...
The :class:`MultiLabelBinarizer <mrex.preprocessing.MultiLabelBinarizer>` is
