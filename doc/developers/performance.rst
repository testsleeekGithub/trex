...
dataset and as in the :ref:`sphx_glr_auto_examples_classification_plot_digits_classification.py` example::
  ...
  In [1]: from mrex.decomposition import NMF

  In [2]: from mrex.datasets import load_digits
...
Now restart IPython and let us use this new toy::
  ...
  In [1]: from mrex.datasets import load_digits

  In [2]: from mrex.decomposition.nmf import _nls_subproblem, NMF
  ...
  File: mrex/decomposition/nmf.py
