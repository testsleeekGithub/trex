...
.. glossary::
    ...
    backwards compatibility
        ...
        Serialization
            ...
            subsequent version.  (For estimators in the mrex package, we
    ...
    categorical feature
        ...
        :class:`~mrex.preprocessing.OrdinalEncoder` helps encoding
        string-valued categorical features as ordinal integers, and
        :class:`~mrex.preprocessing.OneHotEncoder` can be used to
    ...
    cloned
        ...
        :term:`attributes`, using :func:`~mrex.base.clone`.
    ...
    common tests
        ...
        implementation in ``mrex/utils/estimator_checks.py``.
    ...
    examples
        ...
        * as doctests in their docstrings (i.e. within the ``mrex/`` library
          code itself).
...
.. glossary::
    ...
    ``n_jobs``
        ...
        * Some parallelism uses a multi-threading backend by default, some
          ...
          backend by using :func:`mrex.utils.parallel_backend`.
