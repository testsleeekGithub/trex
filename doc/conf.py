...
# documents.
# mrex uses a custom extension: `custom_references_resolver` to modify
...
linkcode_resolve = make_linkcode_resolve('mrex',
...
mrex.set_config(print_changed_only=True)
