...
- The ``labels`` parameter to :func:`mrex.metrics.f1_score`,
  :func:`mrex.metrics.fbeta_score`,
  :func:`mrex.metrics.recall_score` and
  :func:`mrex.metrics.precision_score` has been extended.
...
- Provide an option for sparse output from
  :func:`mrex.metrics.pairwise.cosine_similarity`. By
