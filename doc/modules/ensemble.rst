...
50% of the samples and 50% of the features.
    ...
    >>> from mrex.ensemble import BaggingClassifier
...
The :mod:`mrex.ensemble` module includes two averaging algorithms based
...
The module :mod:`mrex.ensemble` includes the popular boosting algorithm
...
The module :mod:`mrex.ensemble` provides methods
...
(:func:`mrex.datasets.load_boston`).
