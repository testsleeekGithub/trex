...
The :mod:`mrex.metrics.pairwise` submodule implements utilities to evaluate
...
.. currentmodule:: mrex.metrics.pairwise
...
(Note that the tf-idf functionality in ``mrex.feature_extraction.text``
...
:class:`mrex.svm.SVC` with ``kernel="precomputed"``::

    >>> from mrex.svm import SVC
    >>> from mrex.metrics.pairwise import chi2_kernel
    >>> X = [[0, 1], [1, 0], [.2, .8], [.7, .3]]
    >>> y = [0, 1, 0, 1]
