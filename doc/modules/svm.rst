...
=====================
  ...
  * **Avoiding data copy**: For :class:`SVC`, :class:`SVR`, :class:`NuSVC` and
    ...
    <mrex.linear_model.LogisticRegression>`) any input passed as a numpy
    ...
    <mrex.linear_model.SGDClassifier>` class instead.  The objective
...
is advised to use :class:`mrex.model_selection.GridSearchCV` with
...
.. note::
    ...
    estimator used is :class:`mrex.linear_model.Ridge <ridge>` regression,
