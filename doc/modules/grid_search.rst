...
- an estimator (regressor or classifier such as ``mrex.svm.SVC()``);
- a parameter space;
...
consecutive calls.
    ...
    .. warning::
        ...
        the :mod:`mrex.model_selection` module sets the random state provided
...
:func:`mrex.metrics.accuracy_score` for classification and
:func:`mrex.metrics.r2_score` for regression.  For some applications,
