...
Random Projection
==================
.. currentmodule:: mrex.random_projection

The :mod:`mrex.random_projection` module implements a simple and
...
:func:`mrex.random_projection.johnson_lindenstrauss_min_dim` estimates
...
bounded distortion introduced by the random projection::
  ...
  >>> from mrex.random_projection import johnson_lindenstrauss_min_dim
...
==========================
The :class:`mrex.random_projection.GaussianRandomProjection` reduces the
...
projection transformer::
  ...
  >>> import numpy as np
  >>> from mrex import random_projection
...
========================
The :class:`mrex.random_projection.SparseRandomProjection` reduces the
