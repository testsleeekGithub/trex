...
.. currentmodule:: mrex.model_selection
...
.. topic:: Data transformation with held out data
    ...
    A :class:`Pipeline <mrex.pipeline.Pipeline>` makes it easier to compose
...
Or as a dict mapping scorer name to a predefined or custom scoring function::
    ...
    >>> from mrex.metrics.scorer import make_scorer
