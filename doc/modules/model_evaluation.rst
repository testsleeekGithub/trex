...
Usage examples:
    ...
    ValueError: 'wrong_choice' is not a valid scoring value. Use sorted(mrex.metrics.SCORERS.keys()) to get valid options.
...
The module :mod:`mrex.metrics` also exposes a set of simple functions
...
the :func:`fbeta_score` function::
    ...
    >>> from mrex.metrics import fbeta_score, make_scorer
...
The :mod:`mrex.metrics` module implements several loss, score, and utility
...
function::
  ...
  >>> from mrex.metrics import mean_squared_log_error
  >>> y_true = [3, 5, 2.5, 7]
  >>> y_pred = [2.5, 5, 4, 8]
