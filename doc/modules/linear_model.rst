...
.. currentmodule:: mrex.linear_model
...
classifiers. For :math:`\ell_1` regularization :func:`mrex.svm.l1_min_c` allows to
...
.. note:: **P-value estimation**
    ...
    Within mrex, one could use bootstrapping instead as well.
