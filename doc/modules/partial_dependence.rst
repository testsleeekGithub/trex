...
<mrex.ensemble.GradientBoostingRegressor>`:
...
The :mod:`mrex.inspection` module provides a convenience function
...
:func:`mrex.inspection.partial_dependence` function::
...
:func:`mrex.inspection.partial_dependence` gives the actual values
